<template>
  <b-form @submit="onSubmit" @reset="onReset" v-if="show" id="modalInfo">
    <b-row class="mb-3">
      <b-col md="4">
        <image-upload :id="JSON.parse(servicesInfo.content).id" @image="addImage"></image-upload>
      </b-col>
      <b-col md="8">
          ...
          <b-row>
            <b-col sm="12">
              <b-form-group label="Title:">
                <b-form-input
                  type="text"
                  :value="JSON.parse(servicesInfo.content).title"
                  required
              ...
              <b-form-group label="Subtitle:">
                <b-form-input
                  type="text"
                  :value="JSON.parse(servicesInfo.content).subtitle"
                  required
    ...
    <b-row>
      <b-col>
        <b-form-group
          label="Content:"
        >
          <text-editor :value="JSON.parse(servicesInfo.content).content"></text-editor>
        </b-form-group>
